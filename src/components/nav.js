 ...
 return (
    ...
    <BrowserRouter>
      ...
      justify-around items-center rounded-[20px] z-10 border-[2px]'>
        <div className='h-full'><Link to='#home' className='h-full' smooth><h4 className='cursor-pointer h-full flex rounded-[20px] hover:text-[1.1rem] items-center  font-monospace duration-[50ms]'>Home</h4></Link></div>
