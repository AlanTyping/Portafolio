...
export default function Inicio() {
  return (
    <>
      <section id='home' className='h-[245px] w-[100%] home border-b-[10px] border-[var(--orange)] flex justify-center items-center bg-center bg-cover bg-no-repeat'>
        ...
        style={{"backgroundImage": `url(${nieve})`}}>
          <div className={`w-[100%] h-[100%] justify-evenly p-[20px] flex justify-center items-center bg-[rgba(0,0,0,0.60)] text-white flex-col`}>
            <div className='w-full h-[200px] flex justify-center text-center flex-col'>
              ...
              <h2 className='inicio-h2 text-[2rem] text-[orange]'>FRONTEND DEVELOPER</h2>
            </div>
          </div>
        </div>
      </section>
